...
<html>
    <html>
        <head>
            ...
            <title>Update Infor User</title><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
                            ...
                            <div class="card-body">
                                <div class="account-settings">
                                    <div class="user-profile">
                                        ...
                                        <h6 class="user-email">Your Profile</h6>
                                    </div>
                                    <div class="about">
                                    ...
                                    <div class="row gutters">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="text-right">
                                                <button type="button" id="submit" name="submit" class="btn btn-secondary"><a class="cancel" href="ManagerAccount.jsp">Cancel</a></button>
